...
class Coupons
{
    ...
    private ?CouponsTypes $coupons_tpes = null;
    ...
    public function getCouponsTpes(): ?CouponsTypes
    {
        return $this->coupons_tpes;
    }

    public function setCouponsTpes(?CouponsTypes $coupons_tpes): static
    {
        $this->coupons_tpes = $coupons_tpes;
